...
import csv
import t2v_metrics
llava_score = t2v_metrics.VQAScore(model='llava-v1.5-7b')
"""
prepare model
"""
...
def eval(dataset, root_dir, dataset_name):
    ...
    for d in tqdm(dataset):
        ...
        text_probs = llava_score(images = image_name, texts = options)
...
def eval_MMVP(root_dir, dataset_name):
    ...
    with open(csv_file, 'r') as f:
        ...
        for row in reader:
            ...
            text_probs = llava_score(images = [img1_name, img2_name], texts = [text1, text2])
            text_probs = text_probs.T
...
if __name__ == "__main__":
    ...
    with open("evaluation_results.txt", "a") as f:
        f.write("Model path: llava-1.5-7b ")
        f.write("Dataset: {}\n".format(args.dataset))
