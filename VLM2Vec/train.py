...
from src.dataset import TrainDataset, CombinedDataset
...
# from src.vlm_backbone.llava_next.processing_llava_next import LlavaNextProcessor # Should this be used?
from src.vlm_backbone.llava_15.processing_llava import LlavaProcessor
...
def main():
    ...
    if model_args.model_backbone == "llava":
        ...
        processor.tokenizer.padding_side = "right"
    elif model_args.model_backbone == "llava_1.5":
    ...
    if data_args.dataset_name == "CombinedDataset":
        train_dataset = CombinedDataset(data_args, model_args)
